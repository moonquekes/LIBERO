...
SUCTION_DISPLAY_PROXIMITY_THRESHOLD_M="${SUCTION_DISPLAY_PROXIMITY_THRESHOLD_M:-0.05}"
...
conda run -n "$ENV_NAME" python collect_demonstration.py \
  ...
  --suction-display-proximity-threshold-m "$SUCTION_DISPLAY_PROXIMITY_THRESHOLD_M" \
