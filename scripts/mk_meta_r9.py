...
2) 输出 sorting_meta_r9_div.json。
两级均衡逻辑与 r4 完全相同：布局内拉平 + P 层翻倍补形状全局配比。

用法：python scripts/mk_meta_r5.py   # 输出 $D/sorting_meta_r9_div.json
"""
import glob
import json
import os
...
OUT = os.path.join(D, "sorting_meta_r9_div.json")

EXCLUDE = {"round_blue_bin_selfc4", "round_blue_bin_selfc8b"}
