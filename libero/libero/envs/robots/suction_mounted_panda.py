"""
MountedPanda with SuctionGripper instead of the default two-finger PandaGripper.
Drop-in replacement: just change the default_gripper property.
"""
import numpy as np
...
class MountedSuctionPanda(ManipulatorModel):
    """
    Panda arm with a suction-cup end-effector.

    LIBERO 使用约定：传入 robots=["SuctionPanda"]，
    框架会自动加 "Mounted" 前缀，最终查找 "MountedSuctionPanda" 类。
    """
    ...
    def default_gripper(self):
        # ← Only this line differs from MountedPanda
